...
//        Task<bool> UpdateFeedback(UpdateFeedbackRequest feedbackRequest, string accountId, string contractId);
//    }
...
//                {
//                    throw new Exception("Contract must be completed then can feedback");
//                }
...
//        public async Task<bool> UpdateFeedback(UpdateFeedbackRequest feedbackRequest, string accountId, string contractId)
//        {
//            try
//            {
//                Account account = await _accountRepository.GetAccount(accountId);
...
//                Account cosplayer = await _accountRepository.GetAccount(feedbackRequest.CosplayerId);
//                if(cosplayer == null)
//                {
//                    throw new Exception("Cosplayer does not exist");
//                }
