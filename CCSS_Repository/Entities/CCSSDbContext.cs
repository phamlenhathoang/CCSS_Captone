...
new Category { CategoryId = "C17", CategoryName = "Slice of Life", Description = "Everyday life characters" }
     ...
     new Character { CharacterId = "CH015", CharacterName = "Kirby", CategoryId = "C8", Description = "The pink puffball hero of Dream Land with the ability to inhale enemies and copy their powers. Known for his cheerful personality and incredible appetite.", Price = 95000, IsActive = true, MaxHeight = 180, MinHeight = 160, MaxWeight = 80, MinWeight = 60, Quantity = 14, CreateDate = DateTime.UtcNow }
 );
            #endregion
    ...
    new Event { EventId = "E001", EventName = "New Year Festival", Description = "A grand celebration to welcome the new year", Location = "Times Square, New York", LocationId = "L001", IsActive = true, StartDate = new DateTime(2025, 1, 1, 8, 0, 0), EndDate = new DateTime(2025, 1, 2, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending },
    new Event { EventId = "E002", EventName = "Spring Blossom Fest", Description = "Experience the beauty of cherry blossoms", Location = "Kyoto, Japan", LocationId = "L002", IsActive = true, StartDate = new DateTime(2025, 2, 10, 8, 0, 0), EndDate = new DateTime(2025, 2, 12, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.StopSell },
    new Event { EventId = "E003", EventName = "Tech Innovation Summit", Description = "Showcasing the latest in technology and AI", Location = "Silicon Valley", LocationId = "L003", IsActive = true, StartDate = new DateTime(2025, 3, 5, 8, 0, 0), EndDate = new DateTime(2025, 3, 7, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Completed },
    new Event { EventId = "E004", EventName = "Music Fest", Description = "Live performances from top artists", Location = "Coachella, California", LocationId = "L004", IsActive = true, StartDate = new DateTime(2025, 4, 15, 8, 0, 0), EndDate = new DateTime(2025, 4, 17, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Progressing },
    new Event { EventId = "E005", EventName = "Comic-Con International", Description = "A must-attend event for comic book fans", Location = "San Diego Convention Center", LocationId = "L005", IsActive = true, StartDate = new DateTime(2025, 5, 22, 8, 0, 0), EndDate = new DateTime(2025, 5, 24, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Completed },
    new Event { EventId = "E006", EventName = "Anime Expo", Description = "Largest anime convention in the world", Location = "Los Angeles Convention Center", LocationId = "L006", IsActive = true, StartDate = new DateTime(2025, 6, 10, 8, 0, 0), EndDate = new DateTime(2025, 6, 12, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Progressing },
    new Event { EventId = "E007", EventName = "Gaming Expo", Description = "Latest trends and releases in gaming", Location = "Las Vegas Convention Center", LocationId = "L007", IsActive = true, StartDate = new DateTime(2025, 7, 18, 8, 0, 0), EndDate = new DateTime(2025, 7, 20, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Pending },
    new Event { EventId = "E008", EventName = "Summer Festival", Description = "A fun-filled summer celebration", Location = "Miami Beach, Florida", LocationId = "L008", IsActive = true, StartDate = new DateTime(2025, 8, 8, 8, 0, 0), EndDate = new DateTime(2025, 8, 10, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Pending },
    new Event { EventId = "E009", EventName = "Cosplay Festival", Description = "A paradise for cosplayers", Location = "Tokyo Big Sight", LocationId = "L009", IsActive = true, StartDate = new DateTime(2025, 9, 12, 8, 0, 0), EndDate = new DateTime(2025, 9, 14, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending },
    new Event { EventId = "E010", EventName = "Film Festival", Description = "Showcasing the best movies of the year", Location = "Cannes, France", LocationId = "L010", IsActive = true, StartDate = new DateTime(2025, 10, 3, 8, 0, 0), EndDate = new DateTime(2025, 10, 5, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending },
    new Event { EventId = "E011", EventName = "Halloween Night", Description = "Spooky celebrations and costume parties", Location = "Salem, Massachusetts", LocationId = "L010", IsActive = true, StartDate = new DateTime(2025, 11, 1, 8, 0, 0), EndDate = new DateTime(2025, 11, 2, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Pending },
    new Event { EventId = "E012", EventName = "Christmas Market", Description = "Festive shopping and holiday cheer", Location = "Nuremberg, Germany", LocationId = "L007", IsActive = true, StartDate = new DateTime(2025, 12, 20, 8, 0, 0), EndDate = new DateTime(2025, 12, 24, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending }
);
   ...
   new Order { OrderId = "O015", AccountId = "A011", OrderDate = DateTime.Parse("2024-04-10"), TotalPrice = 200000.0, OrderStatus = OrderStatus.Completed, Address = "789 Pine St", Phone = "0903456789", ShipStatus = ShipStatus.WaitToPick, ShipCode = "S015", to_ward_code = "90767", to_district_id = 3695, CancelDate = null }
    ...
    new Request { RequestId = "R009", AccountId = "A009", Name = "Plan Fantasy Fair", Description = RequestDescription.CreateEvent.ToString(), Price = 3000000, Status = RequestStatus.Pending, StartDate = new DateTime(2025, 9, 10), EndDate = new DateTime(2025, 9, 15), ServiceId = "S003", Location = "CM", IsValidate = true },
    new Request { RequestId = "R010", AccountId = "A010", Name = "Rent Halloween Costumes", Description = RequestDescription.RentCostumes.ToString(), Price = 200000, Status = RequestStatus.Browsed, StartDate = new DateTime(2025, 10, 25), EndDate = new DateTime(2025, 10, 25), ServiceId = "S001", Location = "LĐ", IsValidate = true },
    new Request { RequestId = "R011", AccountId = "A011", Name = "Hire Cosplayer for Wedding", Description = RequestDescription.RentCosplayer.ToString(), Price = 800000, Status = RequestStatus.Pending, StartDate = new DateTime(2025, 11, 20), EndDate = new DateTime(2025, 11, 20), ServiceId = "S001", Location = "NT", PackageId = "PKG010", IsValidate = true },
    new Request { RequestId = "R012", AccountId = "A012", Name = "Create Sci-Fi Convention", Description = RequestDescription.CreateEvent.ToString(), Price = 4500000, Status = RequestStatus.Cancel, StartDate = new DateTime(2025, 12, 5), EndDate = new DateTime(2025, 12, 10), ServiceId = "S002", Location = "VT", IsValidate = true },
    new Request { RequestId = "R013", AccountId = "A013", Name = "Rent Santa Claus Costume", Description = RequestDescription.RentCostumes.ToString(), Price = 130000, Status = RequestStatus.Pending, StartDate = new DateTime(2025, 12, 20), EndDate = new DateTime(2025, 12, 25), ServiceId = "S003", Location = "HCM", IsValidate = true },
    new Request { RequestId = "R014", AccountId = "A014", Name = "Book Cosplayer for Product Launch", Description = RequestDescription.RentCosplayer.ToString(), Price = 600000, Status = RequestStatus.Browsed, StartDate = new DateTime(2025, 6, 30), EndDate = new DateTime(2025, 7, 2), ServiceId = "S001", Location = "HN", IsValidate = true },
    new Request { RequestId = "R015", AccountId = "A015", Name = "Host Christmas Event", Description = RequestDescription.CreateEvent.ToString(), Price = 5500000, Status = RequestStatus.Pending, StartDate = new DateTime(2025, 12, 15), EndDate = new DateTime(2025, 12, 15), ServiceId = "S002", Location = "HCM", PackageId = "PKG015", IsValidate = true }
);
            #endregion
    ...
    new Task { TaskId = "T005", TaskName = "CH005", Location = "Ho Chi Minh city", Description = "Professional cosplay photoshoot", IsActive = true, StartDate = DateTime.Now.AddDays(8), EndDate = DateTime.Now.AddDays(9), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Pending, AccountId = "A008", EventCharacterId = "EC005", IsValidate = true },
    new Task { TaskId = "T006", TaskName = "CH006", Location = "Ho Chi Minh city", Description = "Evaluate contestants", IsActive = true, StartDate = DateTime.Now.AddDays(10), EndDate = DateTime.Now.AddDays(11), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Assignment, AccountId = "A010", EventCharacterId = "EC006", IsValidate = true },
    new Task { TaskId = "T007", TaskName = "CH007", Location = "Ho Chi Minh city", Description = "Walk in parade", IsActive = true, StartDate = DateTime.Now.AddDays(12), EndDate = DateTime.Now.AddDays(13), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Progressing, AccountId = "A012", EventCharacterId = "EC007", IsValidate = true },
    new Task { TaskId = "T008", TaskName = "CH008", Location = "Ho Chi Minh city", Description = "Perform on live TV", IsActive = true, StartDate = DateTime.Now.AddDays(14), EndDate = DateTime.Now.AddDays(15), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Completed, AccountId = "A013", EventCharacterId = "EC008", IsValidate = true },
    new Task { TaskId = "T009", TaskName = "CH008", Location = "Ho Chi Minh city", Description = "Perform for charity", IsActive = true, StartDate = DateTime.Now.AddDays(16), EndDate = DateTime.Now.AddDays(17), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Cancel, AccountId = "A015", EventCharacterId = "EC009", IsValidate = true },
    new Task { TaskId = "T010", TaskName = "CH009", Location = "Ho Chi Minh city", Description = "Talk about cosplay industry", IsActive = true, StartDate = DateTime.Now.AddDays(18), EndDate = DateTime.Now.AddDays(19), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Pending, AccountId = "A005", EventCharacterId = "EC010", IsValidate = true },
    new Task { TaskId = "T011", TaskName = "CH010", Location = "Ho Chi Minh city", Description = "New character shoot", IsActive = true, StartDate = DateTime.Now.AddDays(20), EndDate = DateTime.Now.AddDays(21), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Assignment, AccountId = "A008", EventCharacterId = "EC011", IsValidate = true },
    new Task { TaskId = "T012", TaskName = "CH011", Location = "Ho Chi Minh city", Description = "Host main event", IsActive = true, StartDate = DateTime.Now.AddDays(22), EndDate = DateTime.Now.AddDays(23), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Progressing, AccountId = "A007", EventCharacterId = "EC012", IsValidate = true },

    new Task { TaskId = "T013", TaskName = "CH012", Location = "Ho Chi Minh city", Description = "Contract cosplay event", IsActive = true, StartDate = DateTime.Now.AddDays(24), EndDate = DateTime.Now.AddDays(25), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Completed, AccountId = "A013", ContractCharacterId = "CC0021", IsValidate = true },
    new Task { TaskId = "T014", TaskName = "CH013", Location = "Ho Chi Minh city", Description = "Contract cosplay photoshoot", IsActive = true, StartDate = DateTime.Now.AddDays(26), EndDate = DateTime.Now.AddDays(27), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Completed, AccountId = "A011", ContractCharacterId = "CC0051", IsValidate = true },
    new Task { TaskId = "T015", TaskName = "CH014", Location = "Ho Chi Minh city", Description = "Contract character performance", IsActive = true, StartDate = DateTime.Now.AddDays(28), EndDate = DateTime.Now.AddDays(29), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Progressing, AccountId = "A012", ContractCharacterId = "CC0081", IsValidate = true },
    new Task { TaskId = "T016", TaskName = "CH015", Location = "Ho Chi Minh city", Description = "Contract parade participation", IsActive = true, StartDate = DateTime.Now.AddDays(30), EndDate = DateTime.Now.AddDays(31), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Completed, AccountId = "A013", ContractCharacterId = "CC0101", IsValidate = true },
    new Task { TaskId = "T017", TaskName = "CH015", Location = "Ho Chi Minh city", Description = "Contract cosplay workshop", IsActive = true, StartDate = DateTime.Now.AddDays(32), EndDate = DateTime.Now.AddDays(33), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Pending, AccountId = "A014", ContractCharacterId = "CC0141", IsValidate = true }
...
new Package { PackageId = "PKG001", PackageName = "Basic Character Rental", Description = "A great starter package for those looking to rent a single character. Includes a quality costume, basic props, and a 2-hour appearance—perfect for birthdays, intimate gatherings, or themed surprises.", Price = 100000.0 },
new Package { PackageId = "PKG002", PackageName = "Deluxe Character Rental", Description = "Enjoy up to 3 professionally dressed characters with premium costumes, interactive props, and professional makeup. Ideal for corporate functions, community festivals, and mid-sized celebrations.", Price = 250000.0 },
new Package { PackageId = "PKG003", PackageName = "Ultimate Character Rental", Description = "An all-inclusive full-day rental featuring unlimited character changes, deluxe costumes, a full prop set, professional photography, and a dedicated event coordinator. Best suited for conventions and large-scale events.", Price = 500000.0 },
new Package { PackageId = "PKG004", PackageName = "Standard Cosplay Performance", Description = "A 30-minute interactive performance with character-based skits, simple choreography, themed props, and basic audio coordination. Great for smaller events or stage programs.", Price = 150000.0 },
new Package { PackageId = "PKG005", PackageName = "Premium Cosplay Performance", Description = "A dynamic 60-minute show featuring advanced choreography, custom soundtracks, special effects, and audience engagement. Includes costume changes and immersive storytelling.", Price = 300000.0 },
new Package { PackageId = "PKG006", PackageName = "VIP Cosplay Performance", Description = "An exclusive 90-minute theatrical show with cinematic lighting, live music, meet-and-greet opportunities, personalized character moments, and high-end production. Tailored for VIP audiences or gala events.", Price = 500000.0 },
new Package { PackageId = "PKG007", PackageName = "Mini Photography Session", Description = "A fast and fun 30-minute shoot perfect for social media. Includes basic lighting, up to 3 outfit changes, and 15 edited high-resolution photos delivered within 48 hours.", Price = 80000.0 },
new Package { PackageId = "PKG008", PackageName = "Standard Photography Session", Description = "A full 1-hour session with professional lighting, unlimited costume changes, multiple backdrop options, and 50 edited images with creative enhancements and color grading.", Price = 150000.0 },
new Package { PackageId = "PKG009", PackageName = "Full Photography Package", Description = "An immersive 3-hour shoot across multiple locations with pro lighting, makeup artist support, unlimited outfits, over 100 edited photos, and exclusive behind-the-scenes footage.", Price = 300000.0 },
new Package { PackageId = "PKG010", PackageName = "Basic Merchandise Pack", Description = "A fun starter bundle including character keychains, stickers, trading cards, mini-figures, and limited-edition pins. Perfect for beginner collectors or fans.", Price = 50000.0 },
new Package { PackageId = "PKG011", PackageName = "Deluxe Merchandise Pack", Description = "A premium collection of figures, exclusive artwork prints, custom accessories, special edition posters, and signed memorabilia from popular cosplayers.", Price = 150000.0 },
new Package { PackageId = "PKG012", PackageName = "Ultimate Merchandise Pack", Description = "A rare collector’s edition set featuring limited-production statues, handmade accessories, signed artworks, exclusive packaging, and one-of-a-kind items unavailable elsewhere.", Price = 300000.0 },
new Package { PackageId = "PKG013", PackageName = "Cosplay Basics Workshop", Description = "A 4-hour beginner workshop introducing costume creation, makeup basics, character posing, and simple prop making. Includes a starter kit with essential tools and materials.", Price = 100000.0 },
new Package { PackageId = "PKG014", PackageName = "Advanced Cosplay Training", Description = "A 2-day intensive masterclass covering advanced sewing, pro makeup, wig styling, armor building, cosplay photography, and performance coaching with expert instructors.", Price = 2500000 },
new Package { PackageId = "PKG015", PackageName = "Master Cosplay Workshop", Description = "A 5-day professional training program for serious cosplayers. Covers craftsmanship, branding, competition readiness, portfolio building, and mentorship from award-winning artists.", Price = 500000.0 }
);
            #endregion
    ...
    new Payment { PaymentId = "P001", Type = "VNPay", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.BuyTicket, Amount = 250000.0, TransactionId = "TXN001", CreatAt = new DateTime(2025, 3, 2), TicketAccountId = "TA001", AccountCouponID = "AC001" },
    new Payment { PaymentId = "P002", Type = "VNPay", Status = PaymentStatus.Pending, Purpose = PaymentPurpose.BuyTicket, Amount = 150000, TransactionId = "TXN002", CreatAt = new DateTime(2025, 3, 6), TicketAccountId = "TA002" },
    new Payment { PaymentId = "P003", Type = "VNPay", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.BuyTicket, Amount = 90000.0, TransactionId = "TXN003", CreatAt = new DateTime(2025, 3, 11), TicketAccountId = "TA003" },
    new Payment { PaymentId = "P004", Type = "VNPay", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.BuyTicket, Amount = 400000.0, TransactionId = "TXN004", CreatAt = new DateTime(2025, 3, 13), TicketAccountId = "TA004", AccountCouponID = "AC012" },
    new Payment { PaymentId = "P005", Type = "VNPay", Status = PaymentStatus.Cancel, Purpose = PaymentPurpose.BuyTicket, Amount = 175000.0, TransactionId = "TXN005", CreatAt = new DateTime(2025, 3, 16), TicketAccountId = "TA005" },

    new Payment { PaymentId = "P006", Type = "VNPay", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.Order, Amount = 225000.0, TransactionId = "TXN006", CreatAt = new DateTime(2025, 3, 19), OrderId = "O006", AccountCouponID = "AC003" },
    new Payment { PaymentId = "P007", Type = "VNPay", Status = PaymentStatus.Pending, Purpose = PaymentPurpose.Order, Amount = 350000.0, TransactionId = "TXN007", CreatAt = new DateTime(2025, 3, 21), OrderId = "O007" },
    new Payment { PaymentId = "P008", Type = "VNPay", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.Order, Amount = 150000.0, TransactionId = "TXN008", CreatAt = new DateTime(2025, 3, 23), OrderId = "O008" },
    new Payment { PaymentId = "P009", Type = "VNPay", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.Order, Amount = 500000.0, TransactionId = "TXN009", CreatAt = new DateTime(2025, 3, 26), OrderId = "O009" },
    new Payment { PaymentId = "P010", Type = "VNPay", Status = PaymentStatus.Cancel, Purpose = PaymentPurpose.Order, Amount = 125000.0, TransactionId = "TXN010", CreatAt = new DateTime(2025, 3, 29), OrderId = "O010", AccountCouponID = "AC004" },

    new Payment { PaymentId = "P011", Type = "VNPay", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.ContractDeposit, Amount = 325000.0, TransactionId = "TXN011", CreatAt = new DateTime(2025, 3, 31), ContractId = "CT002" },
    new Payment { PaymentId = "P012", Type = "VNPay", Status = PaymentStatus.Pending, Purpose = PaymentPurpose.ContractDeposit, Amount = 410000.0, TransactionId = "TXN012", CreatAt = new DateTime(2025, 4, 3), ContractId = "CT005" },
    new Payment { PaymentId = "P013", Type = "VNPay", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.contractSettlement, Amount = 90000.0, TransactionId = "TXN013", CreatAt = new DateTime(2025, 4, 6), ContractId = "CT008" },
    new Payment { PaymentId = "P014", Type = "VNPay", Status = PaymentStatus.Cancel, Purpose = PaymentPurpose.contractSettlement, Amount = 350000.0, TransactionId = "TXN014", CreatAt = new DateTime(2025, 4, 8), ContractId = "CT010" },
    new Payment { PaymentId = "P015", Type = "VNPay", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.contractSettlement, Amount = 200000.0, TransactionId = "TXN015", CreatAt = new DateTime(2025, 4, 11), ContractId = "CT002" }
);
