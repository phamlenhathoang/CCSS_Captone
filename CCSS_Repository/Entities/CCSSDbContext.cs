...
new Category { CategoryId = "C17", CategoryName = "Slice of Life", Description = "Everyday life characters" }
    ...
    new Event { EventId = "E001", EventName = "New Year Festival", Description = "A grand celebration to welcome the new year", Location = "Times Square, New York", LocationId = "L001", IsActive = true, StartDate = new DateTime(2025, 1, 1, 8, 0, 0), EndDate = new DateTime(2025, 1, 2, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Completed },
    ...
    new Event { EventId = "E006", EventName = "Anime Expo", Description = "Largest anime convention in the world", Location = "Los Angeles Convention Center", LocationId = "L006", IsActive = true, StartDate = new DateTime(2025, 6, 10, 8, 0, 0), EndDate = new DateTime(2025, 6, 12, 17, 0, 0), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending },
