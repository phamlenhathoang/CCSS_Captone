...
new Category { CategoryId = "C17", CategoryName = "Slice of Life", Description = "Everyday life characters" }
    ...
    new Event { EventId = "E002", EventName = "Spring Blossom Fest", Description = "Experience the beauty of cherry blossoms", Location = "Kyoto, Japan", LocationId = "L002", IsActive = true, StartDate = new DateTime(2025, 2, 10), EndDate = new DateTime(2025, 2, 12), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending },
    new Event { EventId = "E003", EventName = "Tech Innovation Summit", Description = "Showcasing the latest in technology and AI", Location = "Silicon Valley", LocationId = "L003", IsActive = true, StartDate = new DateTime(2025, 3, 5), EndDate = new DateTime(2025, 3, 7), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Pending },
    new Event { EventId = "E004", EventName = "Music Fest", Description = "Live performances from top artists", Location = "Coachella, California", LocationId = "L004", IsActive = true, StartDate = new DateTime(2025, 4, 15), EndDate = new DateTime(2025, 4, 17), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Pending },
    new Event { EventId = "E005", EventName = "Comic-Con International", Description = "A must-attend event for comic book fans", Location = "San Diego Convention Center", LocationId = "L005", IsActive = true, StartDate = new DateTime(2025, 5, 22), EndDate = new DateTime(2025, 5, 24), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending },
    new Event { EventId = "E006", EventName = "Anime Expo", Description = "Largest anime convention in the world", Location = "Los Angeles Convention Center", LocationId = "L006", IsActive = true, StartDate = new DateTime(2025, 6, 10), EndDate = new DateTime(2025, 6, 12), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending },
