...
new Category { CategoryId = "C17", CategoryName = "Slice of Life", Description = "Everyday life characters" }
   ...
   new Order { OrderId = "O015", AccountId = "A011", OrderDate = DateTime.Parse("2024-04-10"), TotalPrice = 200000.0, OrderStatus = OrderStatus.Completed, Address = "789 Pine St", Phone = "0903456789", ShipStatus = ShipStatus.WaitToPick, ShipCode = "S015", to_ward_code = "90767", to_district_id = 3695, CancelDate = null }
    ...
    new Task { TaskId = "T001", TaskName = "CH001", Location = "Tokyo", Description = "Cosplay as anime characters", IsActive = true, StartDate = DateTime.Now.AddDays(2), EndDate = DateTime.Now.AddDays(3), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Pending, AccountId = "A001", EventCharacterId = "EC001", IsValidate = true},
    new Task { TaskId = "T002", TaskName = "CH002", Location = "Los Angeles", Description = "Join cosplay contest", IsActive = true, StartDate = DateTime.Now.AddDays(4), EndDate = DateTime.Now.AddDays(5), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Assignment, AccountId = "A004", EventCharacterId = "EC002", IsValidate = true },
    new Task { TaskId = "T003", TaskName = "CH003", Location = "New York", Description = "Teach costume making", IsActive = true, StartDate = DateTime.Now.AddDays(6), EndDate = DateTime.Now.AddDays(7), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Progressing, AccountId = "A005", EventCharacterId = "EC003", IsValidate = true },
    new Task { TaskId = "T004", TaskName = "CH004", Location = "Online", Description = "Host a live event", IsActive = true, StartDate = DateTime.Now.AddDays(1), EndDate = DateTime.Now.AddDays(1), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Completed, AccountId = "A007", EventCharacterId = "EC004", IsValidate = true },
    new Task { TaskId = "T005", TaskName = "CH005", Location = "Paris", Description = "Professional cosplay photoshoot", IsActive = true, StartDate = DateTime.Now.AddDays(8), EndDate = DateTime.Now.AddDays(9), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Pending, AccountId = "A008", EventCharacterId = "EC005", IsValidate = true },
    new Task { TaskId = "T006", TaskName = "CH006", Location = "Berlin", Description = "Evaluate contestants", IsActive = true, StartDate = DateTime.Now.AddDays(10), EndDate = DateTime.Now.AddDays(11), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Assignment, AccountId = "A010", EventCharacterId = "EC006", IsValidate = true },
    new Task { TaskId = "T007", TaskName = "CH007", Location = "Seoul", Description = "Walk in parade", IsActive = true, StartDate = DateTime.Now.AddDays(12), EndDate = DateTime.Now.AddDays(13), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Progressing, AccountId = "A012", EventCharacterId = "EC007", IsValidate = true },
    new Task { TaskId = "T008", TaskName = "CH008", Location = "London", Description = "Perform on live TV", IsActive = true, StartDate = DateTime.Now.AddDays(14), EndDate = DateTime.Now.AddDays(15), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Completed, AccountId = "A013", EventCharacterId = "EC008", IsValidate = true },
    new Task { TaskId = "T009", TaskName = "CH008", Location = "Sydney", Description = "Perform for charity", IsActive = true, StartDate = DateTime.Now.AddDays(16), EndDate = DateTime.Now.AddDays(17), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Cancel, AccountId = "A015", EventCharacterId = "EC009", IsValidate = true },
    new Task { TaskId = "T010", TaskName = "CH009", Location = "San Diego", Description = "Talk about cosplay industry", IsActive = true, StartDate = DateTime.Now.AddDays(18), EndDate = DateTime.Now.AddDays(19), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Pending, AccountId = "A005", EventCharacterId = "EC010", IsValidate = true },
    new Task { TaskId = "T011", TaskName = "CH010", Location = "Bangkok", Description = "New character shoot", IsActive = true, StartDate = DateTime.Now.AddDays(20), EndDate = DateTime.Now.AddDays(21), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Assignment, AccountId = "A008", EventCharacterId = "EC011", IsValidate = true },
    new Task { TaskId = "T012", TaskName = "CH011", Location = "Jakarta", Description = "Host main event", IsActive = true, StartDate = DateTime.Now.AddDays(22), EndDate = DateTime.Now.AddDays(23), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Progressing, AccountId = "A007", EventCharacterId = "EC012", IsValidate = true },

    new Task { TaskId = "T013", TaskName = "CH012", Location = "Tokyo", Description = "Contract cosplay event", IsActive = true, StartDate = DateTime.Now.AddDays(24), EndDate = DateTime.Now.AddDays(25), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Completed, AccountId = "A013", ContractCharacterId = "CC0021", IsValidate = true },
    new Task { TaskId = "T014", TaskName = "CH013", Location = "New York", Description = "Contract cosplay photoshoot", IsActive = true, StartDate = DateTime.Now.AddDays(26), EndDate = DateTime.Now.AddDays(27), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Completed, AccountId = "A011", ContractCharacterId = "CC0051", IsValidate = true },
    new Task { TaskId = "T015", TaskName = "CH014", Location = "Los Angeles", Description = "Contract character performance", IsActive = true, StartDate = DateTime.Now.AddDays(28), EndDate = DateTime.Now.AddDays(29), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Progressing, AccountId = "A012", ContractCharacterId = "CC0081", IsValidate = true },
    new Task { TaskId = "T016", TaskName = "CH015", Location = "Seoul", Description = "Contract parade participation", IsActive = true, StartDate = DateTime.Now.AddDays(30), EndDate = DateTime.Now.AddDays(31), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Completed, AccountId = "A013", ContractCharacterId = "CC0101", IsValidate = true },
    new Task { TaskId = "T017", TaskName = "CH015", Location = "Paris", Description = "Contract cosplay workshop", IsActive = true, StartDate = DateTime.Now.AddDays(32), EndDate = DateTime.Now.AddDays(33), CreateDate = DateTime.Now, UpdateDate = DateTime.Now, Status = TaskStatus.Pending, AccountId = "A014", ContractCharacterId = "CC0141", IsValidate = true }
...
new Package { PackageId = "PKG015", PackageName = "Master Cosplay Workshop", Description = "A 5-day professional training program for serious cosplayers. Covers craftsmanship, branding, competition readiness, portfolio building, and mentorship from award-winning artists.", Price = 500000.0 }
    ...
    new Payment { PaymentId = "P006", Type = "Online", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.Order, Amount = 225000.0, TransactionId = "TXN006", CreatAt = new DateTime(2025, 3, 19), OrderId = "O006", AccountCouponID = "AC003" },
    ...
    new Payment { PaymentId = "P008", Type = "Online", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.Order, Amount = 150000.0, TransactionId = "TXN008", CreatAt = new DateTime(2025, 3, 23), OrderId = "O008" },
    new Payment { PaymentId = "P009", Type = "Online", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.Order, Amount = 500000.0, TransactionId = "TXN009", CreatAt = new DateTime(2025, 3, 26), OrderId = "O009" },
    ...
    new Payment { PaymentId = "P012", Type = "Online", Status = PaymentStatus.Pending, Purpose = PaymentPurpose.ContractDeposit, Amount = 410000.0, TransactionId = "TXN012", CreatAt = new DateTime(2025, 4, 3), ContractId = "CT005" },
    new Payment { PaymentId = "P013", Type = "Online", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.contractSettlement, Amount = 90000.0, TransactionId = "TXN013", CreatAt = new DateTime(2025, 4, 6), ContractId = "CT008" },
    ...
    new Payment { PaymentId = "P015", Type = "Online", Status = PaymentStatus.Complete, Purpose = PaymentPurpose.contractSettlement, Amount = 200000.0, TransactionId = "TXN015", CreatAt = new DateTime(2025, 4, 11), ContractId = "CT002" }
);
