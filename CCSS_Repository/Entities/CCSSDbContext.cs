...
new Category { CategoryId = "C17", CategoryName = "Slice of Life", Description = "Everyday life characters" }
    ...
    new Event { EventId = "E002", EventName = "Spring Blossom Fest", Description = "Experience the beauty of cherry blossoms", Location = "Kyoto, Japan", LocationId = "L002", IsActive = true, StartDate = new DateTime(2025, 2, 10), EndDate = new DateTime(2025, 2, 12), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.StopSell },
    new Event { EventId = "E003", EventName = "Tech Innovation Summit", Description = "Showcasing the latest in technology and AI", Location = "Silicon Valley", LocationId = "L003", IsActive = true, StartDate = new DateTime(2025, 3, 5), EndDate = new DateTime(2025, 3, 7), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Completed },
    new Event { EventId = "E004", EventName = "Music Fest", Description = "Live performances from top artists", Location = "Coachella, California", LocationId = "L004", IsActive = true, StartDate = new DateTime(2025, 4, 15), EndDate = new DateTime(2025, 4, 17), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Progressing },
    new Event { EventId = "E005", EventName = "Comic-Con International", Description = "A must-attend event for comic book fans", Location = "San Diego Convention Center", LocationId = "L005", IsActive = true, StartDate = new DateTime(2025, 5, 22), EndDate = new DateTime(2025, 5, 24), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Completed },
    new Event { EventId = "E006", EventName = "Anime Expo", Description = "Largest anime convention in the world", Location = "Los Angeles Convention Center", LocationId = "L006", IsActive = true, StartDate = new DateTime(2025, 6, 10), EndDate = new DateTime(2025, 6, 12), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Progressing },
    new Event { EventId = "E007", EventName = "Gaming Expo", Description = "Latest trends and releases in gaming", Location = "Las Vegas Convention Center", LocationId = "L007", IsActive = true, StartDate = new DateTime(2025, 7, 18), EndDate = new DateTime(2025, 7, 20), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Pending },
    new Event { EventId = "E008", EventName = "Summer Festival", Description = "A fun-filled summer celebration", Location = "Miami Beach, Florida", LocationId = "L008", IsActive = true, StartDate = new DateTime(2025, 8, 8), EndDate = new DateTime(2025, 8, 10), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Pending },
    new Event { EventId = "E009", EventName = "Cosplay Festival", Description = "A paradise for cosplayers", Location = "Tokyo Big Sight", LocationId = "L009", IsActive = true, StartDate = new DateTime(2025, 9, 12), EndDate = new DateTime(2025, 9, 14), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending },
    new Event { EventId = "E010", EventName = "Film Festival", Description = "Showcasing the best movies of the year", Location = "Cannes, France", LocationId = "L010", IsActive = true, StartDate = new DateTime(2025, 10, 3), EndDate = new DateTime(2025, 10, 5), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending },
    new Event { EventId = "E011", EventName = "Halloween Night", Description = "Spooky celebrations and costume parties", Location = "Salem, Massachusetts", LocationId = "L010", IsActive = true, StartDate = new DateTime(2025, 11, 1), EndDate = new DateTime(2025, 11, 2), CreateDate = DateTime.UtcNow, CreateBy = "Manager", Status = EventStatus.Pending },
    new Event { EventId = "E012", EventName = "Christmas Market", Description = "Festive shopping and holiday cheer", Location = "Nuremberg, Germany", LocationId = "L007", IsActive = true, StartDate = new DateTime(2025, 12, 20), EndDate = new DateTime(2025, 12, 24), CreateDate = DateTime.UtcNow, CreateBy = "Admin", Status = EventStatus.Pending }
);
            #endregion
