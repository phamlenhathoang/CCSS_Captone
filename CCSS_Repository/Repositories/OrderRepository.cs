...
namespace CCSS_Repository.Repositories
{
    public interface IOrderRepository
    {
        ...
        Task<bool> UpdateOrderShipStatus(string orderId, ShipStatus newShipStatus, string? CancelReason);
    ...
    public class OrderRepository : IOrderRepository
    {
        ...
        public async Task<bool> UpdateOrderShipStatus(string orderId, ShipStatus newShipStatus, string? CancelReason)
        {
            ...
            if (newShipStatus == ShipStatus.Cancel && CancelReason != null)
            {
